...
#ifndef TUTORIAL_INTERFACES__SRV__DETAIL__DISPLAY__FUNCTIONS_H_
#define TUTORIAL_INTERFACES__SRV__DETAIL__DISPLAY__FUNCTIONS_H_
...
/// Initialize srv/Display message.
/**
...
/// Create srv/Display message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tutorial_interfaces__srv__Display_Request__init().
...
/// Destroy srv/Display message.
/**
 * It calls
 * tutorial_interfaces__srv__Display_Request__fini()
...
/// Check for srv/Display message equality.
/**
...
/// Initialize array of srv/Display messages.
/**
...
/// Finalize array of srv/Display messages.
/**
 * It calls
 * tutorial_interfaces__srv__Display_Request__fini()
...
/// Create array of srv/Display messages.
/**
 * It allocates the memory for the array and calls
 * tutorial_interfaces__srv__Display_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Display messages.
/**
 * It calls
 * tutorial_interfaces__srv__Display_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Display message array equality.
/**
...
/// Copy an array of srv/Display messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tutorial_interfaces__srv__Display_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tutorial_interfaces
...
/**
 * It calls
 * tutorial_interfaces__srv__Display_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tutorial_interfaces
...
/**
 * It allocates the memory for the array and calls
 * tutorial_interfaces__srv__Display_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tutorial_interfaces
...
/**
 * It calls
 * tutorial_interfaces__srv__Display_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TUTORIAL_INTERFACES__SRV__DETAIL__DISPLAY__FUNCTIONS_H_
