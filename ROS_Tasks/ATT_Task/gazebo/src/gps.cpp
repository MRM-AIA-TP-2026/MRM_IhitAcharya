...
public:
    GpsNavigator() : Node("gps_navigator"){
        ...
        end_pub_ = this->create_publisher<geometry_msgs::msg::Twist>("/cmd_vel", 10);
...
private:
    ...
    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr end_pub_;
    ...
    void navigateToTarget() {
        ...
        double time = std::abs(bearing/0.5);
